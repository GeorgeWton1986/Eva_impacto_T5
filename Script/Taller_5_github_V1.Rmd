...
**Modelo a Sin controles:** El coeficiente estimado (-0.027)*** presenta una correlación entre la variable eduación secundarias en niñas entre los 15 y 20 años y la varible dicótoma que respesenta la victoria del partido islámico en las elecciones de 1994. Por lo tanto, el coeficiente puede estar sesgado, por omisión de variables y no puede ser interpretados como un efecto causal.
...
dev.copy(png, "figura_2b_mccrary_with_hist.png", width = 2400, height = 1800, res = 300)
dev.off()
